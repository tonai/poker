...
<template>
  ...
  >
    <g>
      <circle cx="148.2385" cy="148.2385" r="148" fill="white" />
      <path
        :fill="color"
      ...
      />
      <circle cx="148.2385" cy="148.2385" r="70" fill="white" />
      <circle cx="93.372" cy="53.498" r="8" :fill="color" />
      <circle cx="38.758" cy="148.382" r="8" :fill="color" />
      <circle cx="93.623" cy="243.123" r="8" :fill="color" />
      <circle cx="203.105" cy="242.977" r="8.001" :fill="color" />
      <circle cx="257.717" cy="148.091" r="8" :fill="color" />
      <circle cx="202.853" cy="53.351" r="8" :fill="color" />
    </g>
  </svg>
</template>
